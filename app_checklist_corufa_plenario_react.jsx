...
import { ExpedienteProvider, useExpediente, DEFAULT_LIMITS, EMPTY_EXPEDIENTE } from "./src/context/ExpedienteContext.js";
...
function ChecklistAppInner() {
  const { limits, setLimits, exp, setExp } = useExpediente();
